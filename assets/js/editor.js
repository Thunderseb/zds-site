    ...
    var zForm = {
        ...
        chars: {
            ...
            Autres: {
                ...
                char_td: { title: "~", start: "~", end: "" },
            }
        },

        smilies: {
            0: {
                smiley_sm: { title: ":)",         start: ":)",         end: "", image: "http://zestedesavoir.com/static/smileys/smile.png" },
                smiley_he: { title: ":D",         start: ":D",         end: "", image: "http://zestedesavoir.com/static/smileys/heureux.png" },
                smiley_cl: { title: ";)",         start: ";)",         end: "", image: "http://zestedesavoir.com/static/smileys/clin.png" },
                smiley_la: { title: ":p",         start: ":p",         end: "", image: "http://zestedesavoir.com/static/smileys/langue.png" },
                smiley_ri: { title: ":lol:",      start: ":lol:",      end: "", image: "http://zestedesavoir.com/static/smileys/rire.gif" },
                smiley_un: { title: ":euh:",      start: ":euh:",      end: "", image: "http://zestedesavoir.com/static/smileys/unsure.gif" },
                smiley_tr: { title: ":(",         start: ":(",         end: "", image: "http://zestedesavoir.com/static/smileys/triste.png" },
                smiley_hu: { title: ":o",         start: ":o",         end: "", image: "http://zestedesavoir.com/static/smileys/huh.png" }
            },
            1: {
                smiley_c1: { title: ":colere2:",  start: ":colere2:",  end: "", image: "http://zestedesavoir.com/static/smileys/mechant.png" },
                smiley_oo: { title: "o_O",        start: "o_O",        end: "", image: "http://zestedesavoir.com/static/smileys/blink.gif" },
                smiley_uu: { title: "^^",         start: "^^",         end: "", image: "http://zestedesavoir.com/static/smileys/hihi.png" },
                smiley_si: { title: ":-°",        start: ":-°",        end: "", image: "http://zestedesavoir.com/static/smileys/siffle.png" },
                smiley_an: { title: ":ange:",     start: ":ange:",     end: "", image: "http://zestedesavoir.com/static/smileys/ange.png" },
                smiley_c2: { title: ":colere:",   start: ":colere:",   end: "", image: "http://zestedesavoir.com/static/smileys/angry.gif" },
                smiley_di: { title: ":diable:",   start: ":diable:",   end: "", image: "http://zestedesavoir.com/static/smileys/diable.png" },
                smiley_ma: { title: ":magicien:", start: ":magicien:", end: "", image: "http://zestedesavoir.com/static/smileys/magicien.png" }
            },
            2: {
                smiley_ni: { title: ":ninja:",    start: ":ninja:",    end: "", image: "http://zestedesavoir.com/static/smileys/ninja.png" },
                smiley_gd: { title: "&gt;_&lt;",  start: "&gt;_&lt;",  end: "", image: "http://zestedesavoir.com/static/smileys/pinch.png" },
                smiley_pi: { title: ":pirate:",   start: ":pirate:",   end: "", image: "http://zestedesavoir.com/static/smileys/pirate.png" },
                smiley_pl: { title: ":'(",        start: ":'(",        end: "", image: "http://zestedesavoir.com/static/smileys/pleure.png" },
                smiley_ro: { title: ":honte:",    start: ":honte:",    end: "", image: "http://zestedesavoir.com/static/smileys/rouge.png" },
                smiley_so: { title: ":soleil:",   start: ":soleil:",   end: "", image: "http://zestedesavoir.com/static/smileys/soleil.png" },
                smiley_ww: { title: ":waw:",      start: ":waw:",      end: "", image: "http://zestedesavoir.com/static/smileys/waw.png" },
                smiley_zz: { title: ":zorro:",    start: ":zorro:",    end: "", image: "http://zestedesavoir.com/static/smileys/zorro.png" }
            }
        },
        ...
        setup: function(textareaId) {
            ...
            if (!this.isExecuted) {
                this.addEvent(document, "click", function(event) {
                    /* S'il s'agit d'un bouton de base et que ce n'est pas un sous-bouton (bouton dans un panel) */
